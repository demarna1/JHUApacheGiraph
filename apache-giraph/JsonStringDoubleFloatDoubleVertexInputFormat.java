...
/**
  ...
  */
public class JsonStringDoubleFloatDoubleVertexInputFormat extends
  TextVertexInputFormat<Text, DoubleWritable, FloatWritable> {

  @Override
  public TextVertexReader createVertexReader(InputSplit split,
      TaskAttemptContext context) {
    return new JsonStringDoubleFloatDoubleVertexReader();
  }
  ...
  * [1,4.3,[[2,2.1],[3,0.7]]]
  */
  class JsonStringDoubleFloatDoubleVertexReader extends
    ...
    @Override
    protected Text getId(JSONArray jsonVertex) throws JSONException,
              IOException {
      return new Text(jsonVertex.getString(0));
    }
    ...
    @Override
    protected Iterable<Edge<Text, FloatWritable>> getEdges(
      ...
      for (int i = 0; i < jsonEdgeArray.length(); ++i) {
        ...
        edges.add(EdgeFactory.create(new Text(jsonEdge.getString(0)),
    ...
    @Override
    protected Vertex<Text, DoubleWritable, FloatWritable>
